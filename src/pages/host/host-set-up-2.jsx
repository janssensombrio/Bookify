...
// Icons (UI only)
import { UtensilsCrossed, Mountain, Heart, Landmark, Film, CalendarDays, Trash2, X, ChevronLeft, ChevronRight, LocateFixed, Clock3, Heading1, Users, MapPin, Video, Shield, Languages, Search, Plus, Check, BadgeDollarSign, Info, UploadCloud, ImageIcon, FileText, ShieldCheck, ShieldAlert, CalendarClock } from "lucide-react";
...
export const HostSetUpExperiences = () => {
  ...
  const inputStyle = "w-full rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition px-4 py-2";
    ...
    <div className="host-setup-page bg-gray-50 min-h-screen">
          ...
          >
            ...
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
                Participants & Experience Type
              </h1>
              <p className="mt-2 text-gray-700 text-sm sm:text-base">
                Set how many people can join, choose the format, and define age limits.
              </p>
            </div>
      ...
      {step === 4 && (
        ...
        >
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-2 text-gray-700 text-sm sm:text-base">
              Search, pick from popular options, or add your own.
            </p>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formData.languages?.length || 0} selected
                      </p>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
                  {[
                    ...
                    "German", "Italian", "Portuguese", "Russian", "Tagalog", "Hindi",
                  ].map((label) => {
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {languageOptions
                    .filter((opt) =>
                      (languageInput || "").trim()
                        ? opt.toLowerCase().includes(languageInput.toLowerCase())
                        : true
                    )
                    .slice(0, 12)
                    .map((opt) => {
      ...
      {step === 5 && (
        ...
        >
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
              When will this experience run?
            </h1>
            <p className="mt-2 text-gray-700 text-sm sm:text-base">
              Add specific dates and start times.
            </p>
          </div>
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {formData.schedule?.length || 0} date{(formData.schedule?.length || 0) === 1 ? "" : "s"} added
                    </p>
                  </div>
                </div>
      ...
      {/* 💸 Step 6 — Pricing & Amenities (price card on the right, actions inside) */}
      {step === 6 && (
        <section
          className="
            px-3 sm:px-6 md:px-8 py-12 sm:py-16
            min-h-[calc(100vh-56px)]
            grid grid-rows-[auto,1fr] gap-6
            bg-gradient-to-br from-blue-50 via-white to-indigo-50
          "
        >
          {/* Title */}
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-2 text-gray-700 text-sm sm:text-base">
              Set a clear price and highlight what’s included in your experience.
            </p>
          </div>
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
            ...
            {/* RIGHT — Price + Summary + Actions (inside the card) */}
            <aside
              className="
            ...
            >
              ...
              <div
                className="
                  rounded-2xl border border-blue-100 bg-blue-50/70 p-4
                  shadow-[inset_0_1px_0_rgba(59,130,246,0.15)]
                "
              >
                {(() => {
                  const unit = Number(formData.price || 0);
                  const pax = Math.max(1, Number(formData.maxParticipants || 1));
                  const est = Math.max(0, unit * pax);
    ...
    {step === 7 && (
      ...
      >
        ...
        <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
              ...
              {formData.photos?.length ? (
                    ...
                    {formData.photos.length > 1 && (
                      <>
                        <button
                          ...
                          onClick={() =>
                            setCurrentPhotoIndex((prev) => Math.max(0, (prev || 0) - 1))
                          }
                        ...
                        >
                          ...
                          <span
                            ...
                            onClick={(e) => {
                              ...
                              setCurrentPhotoIndex((prev) =>
                                Math.max(0, Math.min(prev || 0, newPhotos.length - 1))
                              );
                            }}
                            onKeyDown={(e) => {
                            ...
                            className="
                              ...
                              w-7 h-7 rounded-full bg-white/90 hover:bg-white border border-gray-200 shadow
                            "
                          >
                ...
                >
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    No photos uploaded yet. Use the uploader to add images.
                  </p>
                </div>
              )}
            </div>
          ...
          {/* RIGHT — Uploader & Tips (unchanged logic) */}
          <aside
            className="
              lg:sticky lg:top-24 h-fit
              rounded-3xl bg-white/80 backdrop-blur-md border border-white/60
          ...
          >
            <label
              className="
                cursor-pointer rounded-2xl border-2 border-dashed border-blue-300
                bg-white/70 hover:bg-indigo-50/40 transition-colors
                p-6 sm:p-8 flex flex-col items-center justify-center gap-3
              "
            >
              <span
                className="
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3 mt-2">
          ...
          <button
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 px-7 py-3 text-sm font-semibold text-white shadow-md hover:from-blue-600 hover:to-blue-700 transition"
            onClick={nextStep}
          >
            Next
          </button>
      ...
      {/* ✍️ Step 8 — Description & Requirements (themed) */}
{step === 8 && (
  <section
    className="
      px-3 sm:px-6 md:px-8 py-12 sm:py-16
  ...
  >
    ...
    <div className="max-w-3xl mx-auto text-center">
      ...
      <p className="mt-2 text-gray-700 text-sm sm:text-base">
        Help guests understand what makes your experience special and what they should prepare.
      </p>
    </div>

    {/* Content */}
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
      {/* Left: Inputs (span 2 cols) */}
      <div
        className="
          lg:col-span-2 rounded-3xl bg-white/80 backdrop-blur-md border border-white/60
          shadow-[0_8px_20px_rgba(30,58,138,0.08),_0_20px_40px_rgba(30,58,138,0.06)]
          p-5 sm:p-6 md:p-8 grid gap-6
        "
      >
        {/* Description */}
        <div className="grid gap-2">
            ...
            <div className="mt-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
              <div
                ...
                style={{
                  width: `${Math.min(
                    100,
                    ((formData.description?.length || 0) / 800) * 100
                  )}%`,
                }}
              />
            </div>
            ...
            <div className="mt-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
              <div
                ...
                style={{
                  width: `${Math.min(
                    100,
                    ((formData.hostRequirements?.length || 0) / 600) * 100
                  )}%`,
                }}
              />
            </div>
    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3">
      ...
      {/* 🛡️ Step 9 — Cancellation Policy (themed, responsive, no logic changes) */}
      {step === 9 && (
        <section
          className="
            px-3 sm:px-6 md:px-8 py-12 sm:py-16
        ...
        >
          ...
          {/* Content */}
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
            {/* Left: Policy input (spans 2 cols) */}
            <div
              className="
                lg:col-span-2 rounded-3xl bg-white/80 backdrop-blur-md border border-white/60
                shadow-[0_8px_20px_rgba(30,58,138,0.08),_0_20px_40px_rgba(30,58,138,0.06)]
            ...
            >
              ...
              <div className="mt-5 grid gap-2">
                ...
                />
                {/* Helper: character counter + gentle meter (no extra state) */}
                <div className="mt-2 flex items-center justify-between text-xs text-gray-500">
                ...
                <div className="mt-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        100,
                        ((formData.cancellationPolicy?.length || 0) / 600) * 100
                      )}%`,
                    }}
                  />
                </div>
              ...
              {/* Examples / non-interactive guidance */}
      ...
      {/* ✅ Step 10 — Review & Publish (shorter hero, simple details) */}
      {step === 10 && (
        <section
          className="
            px-4 md:px-8 py-10
        ...
        >
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-2 text-gray-700">
              Double-check your details before publishing your experience.
            </p>
          </div>

          {/* Content */}
          <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Left: Photo preview / carousel (shorter heights) */}
            <div
              className="
                ...
                transition-shadow p-4 sm:p-5
                flex flex-col
              "
            >
              {formData.photos?.length ? (
                <>
                  {/* Hero preview — reduced height */}
                  <div
                    className="
                      relative w-full rounded-2xl overflow-hidden border border-gray-200 bg-gray-50
                    ...
                    {formData.photos.length > 1 && (
                      <>
                        <button
                          ...
                          className="
                            absolute left-3 top-1/2 -translate-y-1/2
                            h-10 w-10 rounded-full bg-white/85 hover:bg-white
                            border border-white/60 shadow grid place-items-center
                            disabled:opacity-50 disabled:pointer-events-none
                          "
                        >
            ...
            {/* Right: Simple details card (like earlier version) */}
            <div
              className="
                rounded-3xl bg-white/80 backdrop-blur-md border border-white/60
                shadow-[0_8px_20px_rgba(30,58,138,0.08),_0_20px_40px_rgba(30,58,138,0.06)]
                p-6 sm:p-8 text-left space-y-2
              "
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Listing Details</h2>
              <p><span className="font-semibold text-gray-800">Category:</span> {formData.category || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Listing Type:</span> {formData.listingType || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Title:</span> {formData.title || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Location:</span> {formData.location || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Duration:</span> {formData.duration || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Max Participants:</span> {formData.maxParticipants || 0}</p>
              <p>
                <span className="font-semibold text-gray-800">Age Restriction:</span>{" "}
                {formData.ageRestriction ? `${formData.ageRestriction.min} - ${formData.ageRestriction.max}` : "None"}
              </p>
              <p><span className="font-semibold text-gray-800">Experience Type:</span> {formData.experienceType || "Not set"}</p>
              <p>
                <span className="font-semibold text-gray-800">Languages:</span>{" "}
                {formData.languages?.length > 0 ? formData.languages.join(", ") : "None"}
              </p>
              <p>
                <span className="font-semibold text-gray-800">Schedule:</span>{" "}
                {formData.schedule?.length > 0
                  ? formData.schedule.map((s) => `${s.date} at ${s.time}`).join(", ")
                  : "Not set"}
              </p>
              <p>
              ...
              <p><span className="font-semibold text-gray-800">Description:</span> {formData.description || "Not set"}</p>
              <p><span className="font-semibold text-gray-800">Host Requirements:</span> {formData.hostRequirements || "None"}</p>
              <p><span className="font-semibold text-gray-800">Cancellation Policy:</span> {formData.cancellationPolicy || "Not set"}</p>

              {/* Terms (Policy modal trigger kept) */}
              <div className="pt-2">
