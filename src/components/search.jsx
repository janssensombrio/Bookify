  ...
  return (
    <>
      ...
      <div className="sm:hidden w-full px-4">
        {/* OUTER WRAPPER — low z, no blur (prevents stacking-context fights) */}
        <div className="relative z-10 w-full mx-auto">
          {/* INNER VISUAL CONTAINER — blur lives here */}
      ...
      <div ref={popoverRef} className="hidden sm:block relative z-10 w-full">
        {/* Inner flex container with blur */}
        <div
          className="
        ...
        >
          ...
          >
            ...
            {showDates && (
              <div className="absolute top-full left-0 mt-3 z-40 bg-white shadow-lg shadow-gray-500/20 border border-white/20 rounded-3xl p-3">
                <DateRange
                  editableDateInputs
                  onChange={(item) => setRange([item.selection])}
                  moveRangeOnFirstSelection={false}
          ...
          >
            ...
            {showGuests && (
              <div className="absolute top-full left-0 mt-3 z-40 bg-white border border-blue-100 rounded-2xl shadow-lg p-4 min-w-[260px]">
